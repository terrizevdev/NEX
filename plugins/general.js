...
cmd(
  ...
  async (_0x4e4351) => {
    try {
      ...
      await _0x4e4351.send(util.format(_0x536aa6), {}, "Danny", _0x680da4);
    } catch (_0x2ee8cc) {
...
cmd(
  ...
  async (_0xbda24) => {
    try {
      ...
      await _0xbda24.send(util.format(_0x3e1ea8.url), {}, "Danny", _0x7d6de1);
    } catch (_0x1a2f02) {
  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://api.github.com/repos/DeeCeeXxx/FUTURE_MD-V2d"
      );
      let _0x1c73f9 = (
        "\nFUTURE_MD-V2 A simple Mutil Device WhatsApp Bot Created and Managed by *" +
        Config.ownername +
        "*. 👑\n\n  *❲☆❳ Stars:* " +
        ...
        "\n  *❲☆❳ Repo:* _https://github.com/DeeCeeXxx/FUTURE_MD-V2_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
