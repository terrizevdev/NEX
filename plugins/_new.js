let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `ANONYMOUS-MD 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029Vb57ZHh7IUYcNttXEB3y\n\n ${Config.botname} *©TERRIZEV*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `TO GET ANONYMOUS-MD FILE \n\n *REPO:*https://github.com/Terrizev/ANONYMOUS-MD\n\n ${Config.botname} *SESSION ID*IN REPO`;
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*ANONYMOUS-MD CURRENTLY ACTIVE!*";
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/Terrizev/ANONYMOUS-MD*");
     }
