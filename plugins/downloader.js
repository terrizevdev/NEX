...
`;
 ...
 smd({
   ...
   try {
     ...
     const apiUrl = `https://apis.davidcyriltech.my.id/gdrive?url=${encodeURIComponent(url)}`;
     const response = await fetch(apiUrl);
 ...
 smd(
   ...
   async (message, input) => {
     try {
       ...
       const apiUrl = `https://apis.davidcyriltech.my.id/spotifydl?url=${encodeURIComponent(
         url
       )}`;
   ...
   async (message, input) => {
     try {
       ...
       let video = await astroJson(
         "https://apis.davidcyriltech.my.id/twitter?url=" + query
       );
 ...
 smd(
   ...
   async (msg, query) => {
     try {
       ...
       const apiUrl = `https://apis.davidcyriltech.my.id/search/soundcloud?text=${encodeURIComponent(
         url
       )}`;
 ...
 smd({
   ...
   category: "downloader",
   filename: __filename,
   use: "<Hii,this is ANONYMOUS-MD>"
 }, async (_0x55aba2, _0x56da6b) => {
   try {
     let _0x204f81 = _0x55aba2.reply_text ? _0x55aba2.reply_text : _0x56da6b;
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am ANONYMOUS-MD whatsapp bot._*");
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "ANONYMOUS-MD tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd(
   ...
   async (message, url) => {
     try {
       ...
       const apiUrl = `https://apis.davidcyriltech.my.id/download/tiktok?url=${encodeURIComponent(
         tiktokUrl
       )}`;
       const response = await fetchJson(apiUrl);
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const apiUrl = `https://apis.davidcyriltech.my.id/mediafire?url=${encodeURIComponent(
         url
       )}`;
       const response = await fetch(apiUrl);
       ...
       const caption = `『 *ANONYMOUS-MD • MEDIAFIRE DOWNLOADER* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
 ...
 smd({ pattern: "instagram", category: "downloader", filename: __filename, desc: "Download Instagram media." }, async (m, text) => {
   try {
     ...
     let apiUrl = `https://apis.davidcyriltech.my.id/instagram?url=${text}`;
     let response = await fetch(apiUrl);
     let jsonResponse = await response.json();
 ...
 smd({
   ...
   try {
     ...
     let _0x300d1a = {
       ...
       mimetype: "audio/mpeg",
       fileName: "ANONYMOUS-MD--" + _0x1d542b[1] + ".mp3",
       caption: Config.caption,
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("ANONYMOUS-MD • SONG DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("ANONYMOUS-MD • YOUTUBE DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("ANONYMOUS-MD • APK DOWNLOAD LIST")) {
