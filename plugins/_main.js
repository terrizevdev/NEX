  ...
  try {
    ...
    if (_0xf00650 === "rmbg") {
      ...
      axios.post(_0x242f00(263), _0x142226, {
        headers: {
          "8w7Eb84qAPGVLNPADuGrGXPd": Config[_0x242f00(247)]
        },
...
smd({
  ...
  try {
    try {
      ...
      if (!_0x557719) {
        return man.reply("Provide me a query ex Who is Terrizev");
      }
    ...
    if (Config.OPENAI_API_KEY == "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" || !Config.OPENAI_API_KEY || !("" + Config.OPENAI_API_KEY).startsWith("sk")) {
...
smd({
  ...
  try {
    ...
    if (!_0x1b0897) {
      return _0x42b3b8.reply("Provide me a query ex Who is Terrizev");
    }
    const _0x4c275e = await fetch("https://vapis.my.id/api/openai?q=" + _0x1b0897);
...
smd({
  ...
  try {
    let {
      data: _0x44f98c
    } = await axios.get("https://api.github.com/repos/Terrizev/ANONYMOUS-MD");
    await _0x45da98.react("🪀"); // Added reaction here
    let _0x1c73f9 = ("\nANONYMOUS-MD ᴀ sɪᴍᴘʟᴇ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ, ᴍᴀᴅᴇ ʙʏ Terrizev ᴀɴᴅ ᴅᴇᴘʟᴏʏᴇᴅ ʙʏ *" + Config.ownername + "*.\n\n  *❲❒❳ Stars:* " + (_0x44f98c?.stargazers_count || "120+") + " stars\n  *❲❒❳ Forks:* " + (_0x44f98c?.forks_count || "1000+") + " forks\n  *❲❒❳ Authors:* Terrizev\n  *❲❒❳ Created On:* " + (_0x44f98c?.created_at || "undefined") + "\n  *❲❒❳ Repo:* _https://github.com/Terrizev/ANONYMOUS-MD_\n  *❲❒❳ Scan:* _" + scan + "_" + (Config.caption ? "\n\n" + Config.caption : "")).trim();
...
smd({
  ...
  use: "256702786xx,Your_text_here",
  fromMe: true,
  filename: __filename
...
smd({
  ...
  try {
    ...
    if (_0x48975a[0]) {
      ...
      _0x5f656f = "*ANONYMOUS-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ*\n\n*Msg_Id:* " + _0x3079e2.id + "\n*Date:* _" + _0xbcd286 + "_\n*Time:* _" + _0x47ad13 + "_\n\n*Message:* " + _0x5f656f + "\n\n\n" + Config.caption;
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("ANONYMOUS-MD• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("ANONYMOUS-MD • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
